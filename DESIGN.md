...
$$
S(r_k) = \max\Bigl\{\frac{\max h}{H_{\max}},\; \frac{-\min h}{H_{\max}},\; \frac{\max J}{J^+_{\max}},\; \frac{-\min J}{J^-_{\max}},\; \frac{r_k \cdot \mathrm{RMS}(J)}{J^-_{\max}},\; 1\Bigr\}, \qquad \alpha(r_k) = \frac{1}{S(r_k)}
$$
